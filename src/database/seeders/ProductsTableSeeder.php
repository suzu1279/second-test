...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'description' => 'キウイは甘味と酸味のバランスが絶妙なフルーツです。ビタミンCなどの栄養素も豊富なため、美肌効果や疲労回復効果も期待できます。もぎたてフルーツのスムージーをお召し上がりください!',
        ];
        ...
        $param = [
            ...
            'description' => '爽やかな香りと上品な甘味が特徴的なシャインマスカットは大人から子どもまで大人気のフルーツです。疲れた脳や体のエネルギー補給にも最適の商品です。もぎたてフルーツのスムージーをお召し上がりください!',
        ];
        DB::table('products')->insert($param);
        ...
        $param = [
            ...
            'description' => '低カロリーでありながら栄養満点のため、ダイエット中の方にもおすすめの商品です。１杯でバナナの濃厚な甘味を存分に堪能できます。もぎたてフルーツのスムージーをお召し上がりください!',
        ];
        DB::table('products')->insert($param);
